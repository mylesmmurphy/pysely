(() => {
  ...
  class LspClient {
    ...
    // schema.pyi is written by `pysely typgen`, not by hand. The playground
    ...
    updateGenerated(text) {
      ...
      const uri = "file:///workspace/schema.pyi";
      ...
      this.generated = text;
      this.files["workspace/schema.pyi"] = text;
    }
  ...
  async function startIntelligence(monaco, models, status, retry) {
    ...
    try {
      ...
      client.diagnostics = params => {
        ...
        if (!model) return;
        const generatedUri = model.uri.path === "/workspace/schema.pyi";
  ...
  async function mount() {
    ...
    try {
      ...
      const generatedUri = monaco.Uri.parse("file:///workspace/schema.pyi");
      ...
      const generatedModel = monaco.editor.createModel("# Run to generate schema.pyi", "python", generatedUri);
        ...
        if (!worker) {
          ...
          worker.onmessage = ({ data }) => {
            ...
            if (data.schema && data.schema !== generated) {
              ...
              // schema.py did not generate: Pyright keeps the last good module,
